...
/// </summary>
internal sealed class LayerMaskInfo
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LayerMaskInfo"/> class.
    /// </summary>
    ...
    public LayerMaskInfo(bool isPresent, int rawDataLength)
    {
        IsPresent = isPresent;
