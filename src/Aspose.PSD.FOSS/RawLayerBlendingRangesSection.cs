...
/// </summary>
internal sealed class RawLayerBlendingRangesSection
{
    /// <summary>
    /// Gets an empty blending ranges subsection.
    /// </summary>
    public static RawLayerBlendingRangesSection Empty { get; } = new([]);
    ...
    public RawLayerBlendingRangesSection(byte[] rawData)
    {
        RawData = rawData;
    }
    ...
    /// <returns>The loaded <see cref="RawLayerBlendingRangesSection"/> instance.</returns>
    public static RawLayerBlendingRangesSection Load(BigEndianReader reader, long sectionEnd)
    {
        ...
        return new RawLayerBlendingRangesSection(rawData);
    }
