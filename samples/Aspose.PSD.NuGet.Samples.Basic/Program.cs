...
namespace Aspose.PSD.NuGet.Samples.Basic;
...
internal static class Program
{
    ...
    {
        Console.WriteLine("Aspose.PSD NuGet Basic Sample");
    ...
    {
        Console.WriteLine("Usage: dotnet run --project samples/Aspose.PSD.NuGet.Samples.Basic -- [input.psd]");
