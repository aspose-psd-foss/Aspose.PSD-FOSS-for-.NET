...
- [ ] 1.1 Создать новый проект .NET class library
- [ ] 1.2 Настроить структуру проекта (namespaces, folder layout)
- [ ] 1.3 Настроить метаданные NuGet пакета (имя, версия, автор)
- [ ] 1.4 Добавить README.md с базовыми примерами использования
...
- [ ] 5.7 Реализовать парсинг флагов слоя (видимость, protected transparency и т.д.)
- [ ] 5.8 Реализовать чтение opacity и clipping слоя
- [ ] 5.9 Реализовать парсинг ключа режима смешивания (4 байта)
- [ ] 5.10 Реализовать парсинг channel information (offsets и длины данных каналов)
...
- [ ] 6.3 Парсинг секции image resources (пропуск неизвестных ресурсов как raw bytes)
- [ ] 6.4 Обработка известных ресурсов (Опционально: реализовать только необходимые)
...
- [ ] 8.6 Реализовать запись секции resources (сохранение неизвестных ресурсов)
- [ ] 8.7 Реализовать запись секции layers (обновление layer offset при изменении размера)
...
- [ ] 10.7 Тест round-trip (load → save → load)
