...
- [ ] 2.4 Выделить отдельный тип `PsdVersion` вместо хранения только числового значения версии
...
- [ ] 4.1 Реализовать отдельный класс `ColorData` (или эквивалентный выделенный тип для секции color mode data)
- [ ] 4.2 Реализовать выделенный метод `ColorData.Load`
- [ ] 4.3 Добавить явную обработку RGB color data beyond raw-preserve
- [ ] 4.4 Добавить явную обработку indexed palette, если она присутствует
- [ ] 4.5 Добавить явную обработку CMYK-related color data, если она присутствует
...
- [ ] 5.2 Реализовать отдельный класс `LayerMaskData`
- [ ] 5.3 Реализовать отдельный класс `LayerBlendingRangesData`
...
- [ ] 6.1 Реализовать отдельный класс `ResourceBlock` для заголовков и данных ресурсов
- [ ] 6.2 Реализовать выделенный метод `ResourceBlock.Load`
...
- [ ] 6.5 Добавить обработку известных ресурсов только там, где это действительно требуется текущему scope продукта
- [x] 6.6 **ВАЖНО: сохранять resource data целиком для round-trip**

## 7. Загрузка файла — данные изображения

- [ ] 7.1 Реализовать отдельный класс `ImageData`
- [ ] 7.2 Реализовать выделенный метод `ImageData.Load`
...
- [ ] 8.1 Реализовать отдельный класс `PsdWriter`
...
- [ ] 12.5.5 Все internal/private сущности тоже должны иметь summary там, где это требуется внутренним standard проекта
